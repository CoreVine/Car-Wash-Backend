...
router.post('/brands/', authMiddleware, isAdminMiddleware, brandLogoUploader.single('logo'), carBrandController.createBrand);
router.put('/brands/:brandId', authMiddleware, isAdminMiddleware, brandLogoUploader.single('logo'), carBrandController.updateBrand);
router.delete('/brands/:brandId', authMiddleware, isAdminMiddleware, carBrandController.deleteBrand);
