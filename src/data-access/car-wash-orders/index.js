        ...
        try {
            ...
            try {
                ...
                if (washTypeData && washTypeData.length > 0) {
                    const washOrderWashTypeRepo = this.model.sequelize.models.WashOrderWashType;
                    ...
                    await washOrderWashTypeRepo.bulkCreate(washTypeAssociations, { transaction: t });
                }
    ...
    async addWashServiceToCart(cartId, washOrderData, washTypeIds) {
        try {
            ...
            try {
                ...
                const washOrder = await this.create(washOrderDataWithOrder, { transaction: t });
                ...
                // Create wash type associations
                const WashOrderWashType = this.model.sequelize.model('WashOrderWashType');
                ...
                await WashOrderWashType.bulkCreate(washTypeAssociations, { transaction: t });
